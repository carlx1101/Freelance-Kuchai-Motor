...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="btn-group">
                      ...
                      <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="">
                        <form action="{{ route('admin.bookings.markPaid', [$booking->id]) }}" method="POST">
                          @csrf
                          @method('PATCH')

                          <button class="dropdown-item" type="submit">
                            <i class="bi bi-cash-stack dropdown-item-icon"></i> Mark as Paid
                          </button>
                        </form>
                        <button class="dropdown-item closeDealModalBtn" data-bs-toggle="modal"
                          data-bs-target="#closeDealModal" @if($booking->remarks)
                          data-remarks="{{ $booking->remarks }}" @endif>
                          <i class="bi bi-eye dropdown-item-icon"></i> View Remarks
                        </button>
                      </div>
                      @endif
                    </div>
  ...
  <div class="modal fade" id="closeDealModal" tabindex="-1" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Salesman Remark</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
  ...
  <script>
    $(document).on('click', '.closeDealModalBtn', function() {
      ...
      <div class="row mb-4">
        ...
        <div class="col-sm-9">
          <textarea class="form-control" name="remarks" cols="30" rows="10"
            placeholder="Enter a remark..." disabled>${remarks ? remarks:''}</textarea>
        </div>
      </div>
      <!-- End Form -->
      `;
