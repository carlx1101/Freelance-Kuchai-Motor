        ...
        <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
          ...
          <div class="card h-100">
            <div class="card-body">
              ...
              <div class="row align-items-center gx-2">
                <div class="col">
                  {{-- <span class="js-counter display-4 text-dark">{{$subcategories->count()}}</span> --}}
                </div>
{{--
                <div class="col-auto">
                  <span class="badge bg-soft-success text-success p-1">
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="./user-profile.html">
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">{{$category->category_name}}
                            ...
                            @foreach($category->subcategories as $subcategory)
                                    ...
                                    <ul class="list-pointer list-pointer-soft-bg-primary">
                                        <li class="list-pointer-item d-flex justify-content-between align-items-center">
                                            <span>{{ $subcategory->subcategory_name }}
                ...
                <div class="modal-content">
                    ...
                    <div class="tab-content" id="editSubCategoryModalTabContent">
                        ...
                        <form>
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="subcategory_name" id="editFullNameModalLabel"
        ...
        <div class="modal-content">
            ...
            <div class="tab-content" id="editCategoryModalTabContent">
                ...
                <form>
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" name="category_name" id="editFullNameModalLabel"
...
<!-- End Add category modal-->
  ...
  <script>
    $(document).on('click', '.deleteCategory', function() {
              ...
              let deleteModal =
              `
                  <p class="fs-4">Are you sure you want to remove this category: <b>${category.category_name}</b> ?</p>
    ...
    <script>
        ...
        <div class="tab-content" id="editCategoryModalTabContent">
            ...
            <form action="categories/${category.id}" method="POST">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control @error('category_name') is-invalid @enderror" name="category_name" id="editCategoryModalLabel" placeholder="Your full name"
                    aria-label="Your full name" value="${category.category_name ? category.category_name : ''}">
                    @error('category_name')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
  ...
  <script>
    ...
    <div class="tab-content" id="editSubCategoryModalTabContent">
        ...
        <form action="subcategories/${subcategory.id}" method="POST">
            ...
            <div class="col-sm-9">
                <input type="text" class="form-control @error('subcategory_name') is-invalid @enderror" name="subcategory_name" id="editSubCategoryModalLabel" placeholder="Your full name"
                aria-label="Your full name" value="${subcategory.subcategory_name ? subcategory.subcategory_name : ''}">
                @error('subcategory_name')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
