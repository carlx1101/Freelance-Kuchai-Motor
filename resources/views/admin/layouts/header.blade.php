<header id="header"
  ...
  <div class="navbar-nav-wrap">
    ...
    {{-- <a class="navbar-brand" href="./index.html" aria-label="Front">
      ...
      <img class="navbar-brand-logo-mini" src="{{ asset('backend/svg/logos/logo-short.svg') }}" alt="Logo"
        data-hs-theme-appearance="default">
          ...
          <div class="card">
            ...
            <div class="card-body-height">
              ...
              <a class="dropdown-item" href="./index.html">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-xs avatar-circle" src="{{ asset('backend/img/160x160/img10.jpg') }}"
              ...
              <a class="dropdown-item" href="./index.html">
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <img class="avatar avatar-xs avatar-circle" src="{{ asset('backend/img/160x160/img3.jpg') }}"
                      alt="Image Description">
                  </div>
                  <div class="flex-grow-1 text-truncate ms-2">
                            ...
                            <div class="col-auto">
                              <div class="d-flex align-items-center">
                                ...
                                <img class="avatar avatar-sm avatar-circle"
                                  src="{{ asset('backend/img/160x160/img3.jpg') }}" alt="Image Description">
                              </div>
                            </div>
                            <!-- End Col -->
                          ...
                          <div class="row">
                            <div class="col-auto">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="{{ asset('backend/img/160x160/img7.jpg') }}"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-auto">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="{{ asset('backend/img/160x160/img5.jpg') }}"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-auto">
                              <div class="d-flex align-items-center">
                                ...
                                <div class="avatar avatar-sm avatar-circle">
                                  <img class="avatar-img" src="{{ asset('backend/img/160x160/img8.jpg') }}"
                                    alt="Image Description">
                                </div>
                              </div>
                            </div>
                ...
                <div class="card-body card-body-height">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-xs avatar-4x3"
                          src="{{ asset('backend/svg/brands/atlassian-icon.svg') }}" alt="Image Description">
                      </div>
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-xs avatar-4x3"
                          src="{{ asset('backend/svg/brands/frontapp-icon.svg') }}" alt="Image Description">
                      </div>
                      <div class="flex-grow-1 text-truncate ms-3">
                  ...
                  <a class="dropdown-item" href="#">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0">
                        <img class="avatar avatar-xs avatar-4x3"
                          src="{{ asset('backend/svg/illustrations/review-rating-shield.svg') }}"
                          alt="Image Description">
                      </div>
                      <div class="flex-grow-1 text-truncate ms-3">
