          ...
          <div class="mb-2 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search salesman" aria-label="Search users">
              </div>
              <!-- End Search -->
            </form>
          </div>
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="./user-profile.html">
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">{{ $salesman->name }} <i class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Top endorsed"></i></span>
                    ...
                    <div class="tab-content" id="addSalesmanModalTabContent">
                        <div class="tab-pane fade show active" id="profile" role="tabpanel"
                            ...
                            <form action="{{ route('salesman.store') }}" method="POST">
                                ...
                                <!-- Avatar -->
                                {{-- <label
                                    class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar mb-5"
                                    for="editAvatarUploaderModal">
                                    <img id="editAvatarImgModal" class="avatar-img"
                                        src="{{ asset('assets/img/160x160/img9.jpg') }}" alt="Image Description">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            name="name" id="addNameModalLabel" placeholder="Ex. John Doe"
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                <label for="addPasswordModalLabel"
                                    class="col-sm-3 col-form-label form-label">Password</label>

                                <div class="col-sm-9">
                                    <input type="password" class="form-control @error('password') is-invalid @enderror"
                                        name="password" id="addPasswordModalLabel"
                                        aria-label="Email" value="{{ old('password') }}" value="123456">
                                    @error('password')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-vertical">
                                            <input  type="text" class="js-masked-input form-control" name="phone_number"
                                                id="editPhoneLabel" placeholder="0123456789"
                                                aria-label="+x(xxx)xxx-xx-xx" value="{{ old('contact') }}"
                                            ...
                                            <label class="form-control" for="addSalesmanModalAccountTypeModalRadio1">
                                                <span class="form-check">
                                                    <input type="radio" class="form-check-input"
                                                        name="addSalesmanModalAccountTypeModalRadio"
