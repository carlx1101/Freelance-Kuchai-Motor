                  ...
                  <div class="product-list-info">
                    ...
                    <div>
                      <div class="product-list-info-item"><img class="product-list-info-item__img" src="assets/img/icons/list-info-2.png" alt="icon-list-info">
                        <div class="product-list-info-item__title">Category</div>
                        <div class="product-list-info-item__value">Sports</div>
                      </div>
                    </div>
                    <div>
                      <div class="product-list-info-item">
              ...
              <div class="uk-width-1-3@m">
                <div class="product-block-info">
                  <div class="product-block-info__logos">
                    <img src="assets/img/user-logo-2.png" alt="user-logo">
                </div>
