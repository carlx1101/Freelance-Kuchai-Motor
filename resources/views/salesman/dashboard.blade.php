...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
        ...
        <div class="row align-items-end">
          <div class="col-sm mb-2 mb-sm-0">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-no-gutter">
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Customer Management</a></li>
                <li class="breadcrumb-item"><a class="breadcrumb-link" href="javascript:;">Bookings</a></li>
          ...
          {{-- <div class="col-sm-auto">
            <a class="btn btn-primary" href="{{route('accessories.create')}}">
              <i class="bi-person-plus-fill me-1"></i> Add bookings
            </a>
          </div> --}}
          <!-- End Col -->
        </div>
          ...
          <div class="card h-100">
            <div class="card-body">
              ...
              <div class="row align-items-center gx-2">
                <div class="col">
                  <span class="js-counter display-4 text-dark">{{$bookings->count()}}</span>
          ...
          <div class="mb-2 mb-md-0">
            <form>
              ...
              <div class="input-group input-group-merge input-group-flush">
                ...
                <input id="datatableSearch" type="search" class="form-control" placeholder="Search bookings"
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a class="d-flex align-items-center" href="./user-profile.html">
                    ...
                    <div class="ms-3">
                      <span class="d-block h5 text-inherit mb-0">{{$booking->name}}
                      </span>
                    </div>
                  </a>
                </td>
                <td>
                  <span class="d-block h5 mb-0">{{$booking->email}}</span>
                </td>
                ...
                <td>
                  <span class="fs-5 me-2">{{$booking->datetime}}</span>

                </td>
                <td>
                  <span
                    class="legend-indicator {{ $booking->status === 'Active' ? 'bg-warning' : ($booking->status === 'Closed' ? 'bg-danger' : 'bg-success') }}"></span>
                  {{ $booking->status }}
                </td>
                <td>
                  ...
                  <div class="btn-group" role="group">
                    ...
                    <div class="btn-group">
                      <button type="button" class="btn btn-white btn-icon btn-sm dropdown-toggle dropdown-toggle-empty"
                        id="" data-bs-toggle="dropdown" aria-expanded="false"></button>

                      @if ($booking->status != 'Closed')
                      <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="">
                        <button class="dropdown-item closeDealModalBtn" data-bs-toggle="modal"
                          data-bs-target="#closeDealModal" data-bookingid="{{ $booking->id }}">
                          <i class="bi bi-x-circle dropdown-item-icon"></i> Close Deal
                        </button>
                      </div>
                      @endif
                      @if($booking->remarks)
                      <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="">
                        <button class="dropdown-item closeDealModalBtn" data-bs-toggle="modal"
                          data-bs-target="#closeDealModal" data-bookingid="{{ $booking->id }}" @if($booking->remarks)
                          data-remarks="{{ $booking->remarks }}" @endif>
                          <i class="bi bi-pencil dropdown-item-icon"></i> Edit Remarks
                        </button>
                      </div>
                      @endif
                    </div>
  ...
  <!-- Close Deal Modal -->
  <div class="modal fade" id="closeDealModal" tabindex="-1" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="">Close Deal</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        ...
        <div class="modal-body">
          <form action="" method="POST">
            ...
            <!-- Form -->
            <div class="row mb-4">
              <label for="" class="col-sm-3 col-form-label form-label">Remarks <i
                  class="tio-help-outlined text-body ms-1" data-bs-toggle="tooltip" data-bs-placement="top"
                  title="Close Deal Remarks."></i></label>

              <div class="col-sm-9">
                <textarea class="form-control" name="" cols="30" rows="10" placeholder="Enter a remark..."></textarea>
              </div>
            </div>
            <!-- End Form -->
            <div class="d-flex justify-content-end">
  ...
  <!-- Close Deal Modal JS -->
  <script>
    $(document).on('click', '.closeDealModalBtn', function() {
    let _id = $(this).data('bookingid');

    let modalBody = $('#closeDealModal .modal-body');
    ...
    let template =
    `
    <form action="/salesman/bookings/${_id}/close-deal" method="POST">
      @csrf
      @method('POST')
    
      <!-- Form -->
      <div class="row mb-4">
        <label for="" class="col-sm-3 col-form-label form-label">Remarks <i class="tio-help-outlined text-body ms-1"
            data-bs-toggle="tooltip" data-bs-placement="top" title="Close Deal Remarks."></i></label>
    
        <div class="col-sm-9">
          <textarea class="form-control" name="remarks" cols="30" rows="10" placeholder="Enter a remark...">${remarks ? remarks:''}</textarea>
        </div>
      </div>
      <!-- End Form -->
      <div class="d-flex justify-content-end">
